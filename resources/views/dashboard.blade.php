                                ...
                                <div class="row gy-4 gx-2">
                                    <div class="col-lg-4">
                                        <div class="report-card card align-items-start rounded bg-white h-100">
                                            ...
                                            <span class="badge rounded-pill status-active mb-2">12% <i class="fa fa-arrow-up"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="report-card card align-items-start rounded bg-white h-100">
                                            ...
                                            <p class="card-date">March 20, 2024 - March 20, 2025</p>
                                            <span class="badge rounded-pill status-danger mb-2">12% <i class="fa fa-arrow-down"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="report-card card align-items-start rounded bg-white h-100">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="report-card card align-items-start rounded bg-white h-100">
                                            ...
                                            <p class="card-date">March 20, 2024 - March 20, 2025</p>
                                            <span class="badge rounded-pill status-active mb-2">68 Yes <i class="fa fa-arrow-up"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="report-card card align-items-start rounded bg-white h-100">
                                            ...
                                            <img src="{{ asset('assets/img/icons/emoji-smiling.svg') }}" alt="">
                                            <p class="card-date">March 20, 2024 - March 20, 2025</p>
                                            <span class="badge rounded-pill status-active mb-2">68 Natural <i class="fa fa-arrow-up"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
