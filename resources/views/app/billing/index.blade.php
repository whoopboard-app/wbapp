                                ...
                                <div class="mx-auto p-3">
                                     <div class="basic-information">
                                       ...
                                       <div class="card card-badge modal-note-card mb-2">
                                        ...
                                        <h5 class="fw-semibold font-18 mt-10px">WhoopBoard Free</h5>
                                        ...
                                        <a href="#" class="theme-btn sm fw-semibold mt-10px d-inline-block rounded" data-bs-toggle="modal" data-bs-target="#updatePlan">
                                            Upgrade Plan
                                        </a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <div class="modal-header">
                                                <h3 class="fw-semibold mb-0 fs-3">Other Premium Plan</h3>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            
                                            <!-- Modal Body -->
                                            <div class="modal-body">
                                                <h5 class="font-18 fw-semibold">WhoopBoard Premium</h5>
                                                <p class="label text-black fw-normal">
                                                    Your’re currently on our FREE PLAN. Whoopboard premium has even more features to help you do you best work.
                                                </p>
                                                <ul style="padding-inline-start: 40px;">
                                                    <li class="list-type-disc label">
                                                ...
                                                <div class="toggle-btn-group mt-10px">
                                                    <button class="toggle-btn label fw-semibold" id="perMonthBtn">Per month</button>
                                                    <button class="toggle-btn label fw-semibold active" id="annualPlanBtn">Annual Plan</button>
                                                </div>
                                                <h5 class="fw-semibold font-24 mt-10px">$79.00</h5>
                                            </div>
                                            
                                            <!-- Modal Footer -->
                                            <div class="modal-footer justify-content-start border-top-0">
                                                <button type="button" class="theme-btn fw-semibold rounded border-0">Update &amp; Continue</button>
                        ...
                        <div class="card p-0 bg-white mb-3">
                            <form action="#" class=" form">
                                ...
                                <div class="card-footer gap15 px-3 bg-light d-flex justify-content-start">
                                    <a href="#" class="theme-btn sm fw-normal font-12 d-inline-block rounded " style="background-color: #FE3819;">
                                        Delete Account    
                                    </a>
                                </div>
                            </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    perMonthBtn.addEventListener('click', function() {
        ...
        // Optional: handle showing monthly pricing content
        console.log('Per month selected');
    });

    annualBtn.addEventListener('click', function() {
        annualBtn.classList.add('active');
        perMonthBtn.classList.remove('active');
        // Optional: handle showing annual pricing content
