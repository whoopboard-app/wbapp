                ...
                <div class="card  p-0 bg-white mb-3">
                    <div class="d-flex align-items-center border-title justify-content-between">
                        ...
                        <div class="btn-wrapper d-flex align-items-center justify-content-center gap15 flex-wrap mb-0">
                            ...
                            <div class="icon-box">
                                <a href="{{route('announcement.edit', $article->id)}}"><img src="{{ asset('assets/img/icon/edit.svg') }}" alt="Edit"></a>
                                ...
                                <div class="divider"></div>
                                <form action="{{ route('announcement.destroy', $article->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this announcement?');">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <div class="mx-auto p-3">
                        <div class="d-flex justify-content-start">
                            <div class="d-inline-block">
                                <a href="#">
                                <span class="badge fw-normal bg-white {{ strtolower($article->status) }} rounded-pill">
                            ...
                            <div class="tags-wrapper d-flex flex-wrap">
                                @foreach($tagNames as $tagName)
                                    <span class="tag d-inline-flex align-items-center rounded-pill fw-semibold">
                                        <span class="tag-color green d-block rounded-circle"></span> {{ $tagName }}
                                    </span>
                                @endforeach
                            </div>
                        </div>
                            ...
                            <div class="changelog-detail-item d-flex flex-column">
                                @if($article->article_banner)
                                    <div class="img-block mt-3 position-relative">
                                        <img src="{{ asset('storage/' . $article->article_banner) }}" alt="banner" class="w-100 h-100 object-fit-cover">
