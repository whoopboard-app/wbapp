...
@if ($errors->any())
    ...
    @endforeach
@endif
<div class="d-flex justify-content-between py-2 pb-0">
    <h4 class="fw-medium font-16">Add Board Article</h4>
...
<section class="section-content-center view-changelog main-content-wrapper p-0">
            <div class="row">
